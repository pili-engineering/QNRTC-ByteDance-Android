...
import com.qiniu.droid.rtc.demo.adapter.StickerRVAdapter;
import com.qiniu.droid.rtc.demo.fragment.contract.OnCloseListener;
import com.qiniu.droid.rtc.demo.fragment.contract.StickerContract;
import com.qiniu.droid.rtc.demo.fragment.contract.presenter.StickerPresenter;
...
public class StickerFragment extends BaseFeatureFragment<StickerContract.Presenter, StickerFragment.IStickerCallback>
    ...
    public void onItemClick(StickerModel item) {
        if (item.getTip()!=null) {
            ToastUtils.s(getContext(), item.getTip());
        }
        if (getCallback() == null) {
            return;
        }
